...
public class PingSettings extends Settings {
    ...
    private static final String KEY_PING_DURATION_SECONDS = "ping-duration-seconds";
    ...
    private int pingDurationSeconds = 20;
    ...
    private Item pingItem = Items.STAINED_GLASS.blue();
    ...
    protected void saveSettings() {
        ...
        cfg.put(KEY_PING_DURATION_SECONDS, pingDurationSeconds);
    ...
    protected void loadSettings() {
        ...
        if(cfg.containsKey(KEY_PING_DURATION_SECONDS))
            pingDurationSeconds = cfg.getInteger(KEY_PING_DURATION_SECONDS);
        ...
        if(cfg.containsKey(KEY_PING_ITEM)) {
            ...
            if(!Compat.itemExists(pingItemIdentifier))
                pingItem = Items.STAINED_GLASS.blue();
            else
        ...
        if(pingDurationSeconds < 1)
            pingDurationSeconds = 1;
    ...
    public int getPingDurationTicks() {
        return pingDurationSeconds * 20;
    }
